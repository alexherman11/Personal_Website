  ...
  grand_hall: {
    ...
    objects: {
      ...
      welcome_mat: {
        ...
        examineText: 'The mat is threadbare from use. Stitched along its border in fading thread: "Lifeguard. Surfer. Rock climber. Builder of tree nets. Allegedly an excellent cook." Someone has added in smaller letters: "Also once tore his ACL. Still plays ultimate frisbee."',
      },
    },
    items: {
      golden_compass: {
